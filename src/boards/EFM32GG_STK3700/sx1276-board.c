...
{
// TODO: I had to enable boost to get decent communication
...
{
	// TXRX pin is not used on HopeRF RFM95
    GpioInit( &AntSwitchLf, NC, PIN_OUTPUT, PIN_PUSH_PULL, PIN_PULL_UP, 1 );
    GpioInit( &AntSwitchHf, NC, PIN_OUTPUT, PIN_PUSH_PULL, PIN_PULL_UP, 0 );
}

void SX1276AntSwDeInit( void )
{
	// TXRX pin is not used on HopeRF RFM95
    GpioInit( &AntSwitchLf, NC, PIN_OUTPUT, PIN_OPEN_DRAIN, PIN_NO_PULL, 0 );
